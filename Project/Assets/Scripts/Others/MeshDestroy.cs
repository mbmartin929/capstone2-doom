    ...
    public class MeshDestroy : MonoBehaviour
    {
        ...
        public void DestroyMesh()
        {
            ...
            for (var i = 0; i < parts.Count; i++)
            {
                ...
                Vector3 direction = gameObject.transform.position - GameManager.Instance.playerGo.transform.position * 1.75f;
                parts[i].GameObject.GetComponent<Rigidbody>().AddForce(direction * ExplodeForce);
            }
